...
void AParaglideHUD::DrawHUD()
{
	...
	const FString EnergyLine = FString::Printf(
		TEXT("AGL %.0f m | AoA %.1f deg | Pressure %.0f%% | Inflation %.0f%% | G %.2f"),
	...
	const FString RiskLine = FString::Printf(
		TEXT("Stall %.0f%% | Dive %.0f%% | Tumble %.0f%% | Collapse L/R %.0f / %.0f | Surge %.0f deg"),
	...
	DrawPanel(36.0f, 36.0f, 780.0f, 294.0f, FLinearColor(0.02f, 0.04f, 0.07f, 0.76f), FLinearColor(0.42f, 0.73f, 1.0f, 0.62f));
	...
	DrawTextLine(58.0f, 256.0f, LandingLine, FLinearColor(0.82f, 0.88f, 1.0f, 1.0f), 0.9f);
	...
	DrawTextLine(58.0f, Canvas->ClipY - 78.0f, TEXT("1-5 scenarios | R reset | Tab HUD"), FLinearColor(0.7f, 0.83f, 1.0f, 1.0f), 0.85f);
}
